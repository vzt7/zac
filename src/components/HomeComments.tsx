          ...
          {[
            {
              ...
              name: 'Alice Johnson',
              rating: 4,
              comment: 'Great service and amazing quality! Highly recommend.',
            },
            {
              avatar:
                'https://images.unsplash.com/photo-1595152772835-219674b2a8a6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1180&q=80',
            ...
            },
            {
              ...
              name: 'Emily Davis',
              rating: 3,
              comment: 'The product is good, but the delivery was late.',
            },
            {
              avatar:
                'https://images.unsplash.com/photo-1595152772835-219674b2a8a6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1180&q=80',
            ...
            <div className="mb-8 sm:break-inside-avoid">
              <blockquote className="rounded-lg bg-gray-100/50 backdrop-blur-md p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-black text-lg">{item.comment}</p>
              </blockquote>
            </div>
          ))}
        </div>
